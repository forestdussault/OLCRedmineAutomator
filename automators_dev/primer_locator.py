...
def primer_locator_redmine(redmine_instance, issue, work_dir, description):
    ...
    # Current list of analysis types that the primer locator can support
    analyses = [
        'vtyper', 'custom'
    ]
    ...
    try:
            ...
            redmine_instance.issue \
                .update(resource_id=issue.id,
                        notes='WARNING: No program type provided. Please ensure that issue contains '
                              ...
                              'https://olc-bioinformatics.github.io/redmine-docs/analysis/primer_locator/ '
            ...
            redmine_instance.issue \
                .update(resource_id=issue.id,
                        notes='WARNING: Requested program type: {pt} not in list of supported analyses: {pts}. Please '
                              'see https://olc-bioinformatics.github.io/redmine-docs/analysis/primer_locator/ '
        ...
        primer_locator_script = os.path.join(work_dir, 'run_primer_locator.sh')
        with open(primer_locator_script, 'w+') as file:
            file.write(template)
        # Modify the permissions of the script to allow it to be run on the node
        make_executable(primer_locator_script)
        # Run shell script
        os.system(primer_locator_script)

        # Zip output
        output_filename = 'primer_locator_output'
        ...
        redmine_instance.issue.update(resource_id=issue.id,
                                      uploads=output_list,
                                      status_id=4,
                                      notes='{at} analysis with primer locator complete!'
        ...
        redmine_instance.issue.update(resource_id=issue.id,
                                      notes='Something went wrong! Send this error traceback to your friendly '
                                            ...
                                            'the usage guide: '
                                            'https://olc-bioinformatics.github.io/redmine-docs/analysis/in_silico_pcr/'
                                      .format(error=e))
